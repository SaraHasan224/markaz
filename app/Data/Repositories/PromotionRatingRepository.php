...
use App\PromotionRating;
use App\Contracts\RepositoryContract;


class PromotionRatingRepository extends AbstractRepository implements RepositoryContract {
     ...
     *
     **/
    protected $_cacheKey = 'promotion-ratings-';
    protected $_cacheTotalKey = 'total-promotion-ratings';

    public function __construct(PromotionRating $rating) {
        $this->model = $rating;
    ...
    public function getRatingsOfPromotion(array $data = []){
        $input['promotion_id']   = $data['promotion_id'];
