                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="JavaScript:void(0);" class="m-nav__link">
                            <span class="m-nav__link-text"><?php echo e((!empty($store)) ? $store->name : 'MARKAZ'); ?></span>
                        </a>
                    </li>
                    <li class="m-nav__separator">-</li>
                    <li class="m-nav__item">
                        <a href="<?php echo e(url('faq')); ?>/<?php if(!empty($store)): ?>  <?php echo e($store->id); ?> <?php endif; ?>" class="m-nav__link">
    ...
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--space">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            Frequently Asked Questions of <?php if(!empty($store)): ?> <?php echo e($store->name); ?> <?php else: ?> MARKAZ <?php endif; ?>
                        </h3>
                    </div>
                </div>
            </div>
			<form class="faq"  id="faq" method="POST">
                ...
                <input type="hidden" name="store_id" value="<?php if($store): ?> <?php echo e($store->id); ?> <?php else: ?> 0 <?php endif; ?>"/>
