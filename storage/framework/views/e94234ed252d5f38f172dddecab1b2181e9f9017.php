                ...
                <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark "
                    ...
                    <ul class="m-menu__nav ">
                        ...
                        <!-- <li class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1"><a
                                href="<?php echo e(url('events')); ?>" class="m-menu__link "><span class="m-menu__item-here"></span><i
                                    class="m-menu__link-icon flaticon-suitcase"></i><span
                                    class="m-menu__link-text">Events</span></a></li> -->

                        <li class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1"><a
                                href="<?php echo e(url('support')); ?>" class="m-menu__link "><span class="m-menu__item-here"></span><i
                                    class="m-menu__link-icon flaticon-suitcase"></i><span
