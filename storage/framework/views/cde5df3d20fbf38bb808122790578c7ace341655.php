                    ...
                    <div class="tab-content">
                                                    ...
                                                    <div class="masonry-wrapper">
                                                        <div class="masonry">
                                                            ...
                                                            <div class="masonry-item">
                                                                <img src="<?php echo e(asset('images/promotion_media/'.$media->media_id)); ?>"
                        ...
                        <div class="tab-pane active" id="m_tabs_9_2" role="tabpanel">
                            ...
                            <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                id="stores" action="<?php echo e(url('poststore')); ?>" method="POST">
                                <div class="m-portlet__body">
                                    <div
                                        class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?> m-form__group row">
                                        <div class="col-lg-6">
                                    ...
                                    <div
                                        class="form-group<?php echo e($errors->has('address') ? ' has-error' : ''); ?> m-form__group row">
                                        <div class="col-lg-6">
