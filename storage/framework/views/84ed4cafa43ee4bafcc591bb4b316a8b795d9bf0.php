					...
					<div class="m-login__container">
						...
						<div class="m-login__signup">
							...
							<form class="m-login__form m-form" id="signup_form" method="POST">
								<div class="form-group<?php echo e($errors->has('organization') ? ' has-error' : ''); ?> m-form__group">
									<input class="form-control m-input" type="text" placeholder="Enter your organization name" name="signup_organization" value="<?php echo e(old('signup_organization')); ?>" autofocus>
									<?php if($errors->has('signup_organization')): ?>
										<span class="help-block">
											<strong><?php echo e($errors->first('signup_organization')); ?></strong>
										</span>
                                	<?php endif; ?>
								</div>
								<div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?> m-form__group">
									<input class="form-control m-input" type="text" placeholder="Enter your name" name="signup_name" value="<?php echo e(old('name')); ?>">
