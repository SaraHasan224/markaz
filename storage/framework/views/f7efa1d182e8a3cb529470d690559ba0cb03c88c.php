        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="m-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="<?php echo e($table_id); ?>" method="POST">
                        ...
                        <div id="result" style="padding: 10px;"></div>
                            ...
                            <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?> m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="m-input-icon m-input-icon--right">
                                        <input type="text" name="phone_number" class="form-control m-input" value="<?php echo e(($user) ? $user->phone_number : ''); ?>"
