        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__separator">-</li>
                    <li class="m-nav__item">
                        <a href="<?php echo e(url('faq')); ?>/<?php echo e($store->id); ?>" class="m-nav__link">
    ...
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--space">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            Frequently Asked Questions of <?php echo e($store->name); ?>
			...
			<form class="faq"  id="faq" method="POST">
                ...
                <input type="hidden" name="user_id" value="<?php echo e($logged_user->id); ?>"/>
