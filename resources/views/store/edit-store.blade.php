        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="m-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="stores" action="{{url('edit-store/'.$store->id)}}" method="POST">{{csrf_field()}}
                        <div class="m-portlet__body">
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} m-form__group row">
                                <div class="col-lg-6">
                                    <label>Store Name:</label>
                                    <input type="text" name="name" class="form-control m-input" placeholder="Enter store name" value="{{$store->name}}">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="contact_number" class="form-control m-input"
                                        placeholder="Enter store contact number" value="{{$user->phone_number}}">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="m-input-icon m-input-icon--right">
                                        <input type="text" name="address" class="form-control m-input"
                                            placeholder="Enter your address"  value="{{$store->address}}">
...
<script>
    ...
    // 		},
    // 		url: '{{url("poststore")}}',
    // 		data: JSON.stringify($("#stores").serialize()),
