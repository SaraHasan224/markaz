                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable" style="width: 950px !important;" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="3">
                                            <button type="button" class="btn m-btn--pill btn-focus response"id="assign_permit" data-id="{{$r->id}}" title="Assign Permission"><i class="m-menu__link-icon flaticon-user-ok"></i>Assign Permission</button>
                                        </th>
                                    </tr>
                                    @endforeach
                                </tbody>
